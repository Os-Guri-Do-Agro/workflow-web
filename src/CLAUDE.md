...
| OCR Digital     | [`features/ocr/OcrDigitalView.vue`](./features/ocr/OcrDigitalView.vue)                         | `/ocr`             | Ferramenta de integração (seção Ferramentas): template por empresa, acervo de documentos lidos, webhook. Spec: docs/specs/ocr-digital.md |
